...
public class XTWidgetActors(
    ...
    private void DrawHeader(){
        ...
        XUI.Button(SpawnActor, FontAwesomeIcon.Plus, XUI.Size.BtnMid, XUI.Inline.Yes);
        XUI.Button(CloneActor, FontAwesomeIcon.Copy, XUI.Size.BtnMid, XUI.Inline.Yes);
        XUI.Button(SpawnProp, FontAwesomeIcon.PlusCircle, XUI.Size.BtnMid, XUI.Inline.Yes);
        XUI.Button(TargetActor, FontAwesomeIcon.Bullseye, XUI.Size.BtnMid, XUI.Inline.Yes);
        XUI.Button(DestroyActor, FontAwesomeIcon.Minus, XUI.Size.BtnMid);
